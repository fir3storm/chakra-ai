...
- Demands strict branding consistency across ALL surfaces — when rebranding, expects every file (banner, CLI output, batch scripts, README, UI, tests) to reflect the same brand name with zero leftover references to old names. "Entire tool is branded as X and nothing else." Confidence: 0.9
