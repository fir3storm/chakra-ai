...
from kimipy.multi_agent import MultiAgentOrchestrator
from kimipy.model import K3Config, K3Model, tiny_config
...
SESSIONS_DIR = Path(".kimipy_sessions")
...
def main(args: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(
        description="kimipy: Pure PyTorch runner and CLI for Kimi K3"
    )
    parser.add_argument(
        "--preset",
